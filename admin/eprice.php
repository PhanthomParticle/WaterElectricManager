...
<body>
	...
	<p>
		...
		<input type="text" name="area" id="area" placeholder="区号"><input type="text" name="setPrice" id="setPrice" placeholder="电价"><span id="setButton" onclick="return setPrice()">整区设置</span>
	</p>
	<ul id="list">
		<?php
